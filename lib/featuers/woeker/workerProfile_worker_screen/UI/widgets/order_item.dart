...
import 'package:homehand/featuers/woeker/workerProfile_worker_screen/UI/widgets/order_buttons.dart';
import 'package:homehand/featuers/woeker/workerProfile_worker_screen/data/model/get_all_orders_to_workers.dart';

class OrderItemWorkwe extends StatelessWidget {
  OrderItemWorkwe({Key? key, required this.Orders}) : super(key: key);
  final Order Orders;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text(
                      '${Orders.userId!.firstName} ${Orders.userId!.secondName}',
          ...
          verticalSpace(25),
          OrderWButtons(isPending:Orders.orderStatus,order: Orders, ),
        ],
      ),
    );
  }
