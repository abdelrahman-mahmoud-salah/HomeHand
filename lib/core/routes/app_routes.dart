  ...
  static Route<void> onGenerateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case RoutesApp.homeCustomer:
        return BaseRoute(page: HomeScreen(data: args as LoginResponse,));
